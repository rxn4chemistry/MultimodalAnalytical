...
for cv_split in 0 1 2 3 4; do
        ...
        for set in smiles_rad_1 smiles_rad_2 smiles_rad_3; do
            ...
            jbsub -queue x86_6h -cores 7+1 -mem 25g \
                -out ${run_folder}/${set}_num_2/finetuning/cv_split_${cv_split}/out.txt \
                -err ${run_folder}/${set}_num_2/finetuning/cv_split_${cv_split}/err.txt \
        ...
        for set in smiles_rad_1 smiles_rad_2 smiles_rad_3; do
            ...
            jbsub -queue x86_6h -cores 7+1 -mem 25g \
                -out ${run_folder}/formula_${set}_num_2/finetuning/cv_split_${cv_split}/out.txt \
                -err ${run_folder}/formula_${set}_num_2/finetuning/cv_split_${cv_split}/err.txt \
                python -m analytical_fm.cli.training \
                    working_dir=${run_folder} \
