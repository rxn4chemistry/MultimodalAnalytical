#!/usr/bin/env python
"""
make_input_cpmd_with_vdW_from_xyz.py
...
Same as make_input_cpmd_from_xyz.py but with vdW.
...
if __name__ == "__main__":
    ...
    with Path(filexyz).open('r') as fxyz:
        atoms = []
        pos = []
    ...
    if False:
        ...
        with Path(filexyz_new).open('w') as fout:
    ...
    if make_geop:
        ...
        with Path(filecpmd).open('w') as fout:
