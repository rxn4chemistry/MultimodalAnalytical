...
def load_df(path_to_parquet_folder):
    ...
    files = [
        base_path / "IR_data_chunk001_of_009.parquet",
        base_path / "IR_data_chunk002_of_009.parquet",
        base_path / "IR_data_chunk003_of_009.parquet",
        base_path / "IR_data_chunk004_of_009.parquet",
        base_path / "IR_data_chunk005_of_009.parquet",
        base_path / "IR_data_chunk006_of_009.parquet",
        base_path / "IR_data_chunk007_of_009.parquet",
        base_path / "IR_data_chunk008_of_009.parquet",
        base_path / "IR_data_chunk009_of_009.parquet",
    ]
