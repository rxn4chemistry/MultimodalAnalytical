...
exp_dir=msms_cfmid_P10 #train_HFModel_customBeam_${modality}_${lr}_repeated

# column=msms_cfmid_positive_10ev
columns=("msms_cfmid_positive_10ev" "msms_cfmid_positive_20ev" "msms_cfmid_positive_40ev" "msms_cfmid_fragments_positive" "msms_cfmid_negative_10ev" "msms_cfmid_negative_20ev" "msms_cfmid_negative_40ev" "msms_cfmid_fragments_negative" "msms_iceberg_positive" "msms_iceberg_fragments_positive" "msms_scarf_positive" "msms_scarf_fragments_positive")
job_names=("msms_cfmid_p10" "msms_cfmid_p20" "msms_cfmid_p40" "msms_cfmid_fp" "msms_cfmid_n10" "msms_cfmid_n20" "msms_cfmid_n40" "msms_cfmid_fn" "msms_iceberg_p" "msms_iceberg_fp" "msms_scarf_p" "msms_scarf_fp")
